...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-sm" style="line-height:1.6em;margin-top:3px;float:right" href="<%=path%>/findPosition" title="刷新">
        <i class="layui-icon" style="line-height:30px">&#xe669;</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="<%=path%>/findPosition" >
            <input class="layui-input" type="hidden" name="pageIndex" value="1">
            <input class="layui-input" type="hidden" name="pageSize" value="5">
            <div class="layui-inline layui-show-xs-block">
                <input type="text" name="name"  placeholder="请输入岗位名称" class="layui-input" placeholder="">
            </div>
            <div class="layui-inline layui-show-xs-block">
    ...
    <xblock>
        <button id="addPositionBtn" class="layui-btn layui-btn-sm"> <i class="layui-icon">&#xe654;</i>添加 </button>
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${pageList.list}" var="di">
            <tr>
                ...
                <td>
                    <a title="编辑" id= "updateEdit" href="<%=path%>/findPositionById?id=${di.id}">
    ...
    <div class="layui-row" id="test" style="display: none;">
        <div class="layui-col-md10">
            <form class="layui-form" id="addPositionForm">
    ...
    <script>
        ...
        layui.use(['jquery', 'excel','form','layer','laydate'], function(){
            ...
            $("#addPositionBtn").click(function () {
                ...
                form.on('submit(formDemo)', function(data) {
                    ...
                    $.ajax({
                        url: '<%=path%>/addPosition',
                        type: "post",
                        data:JSON.stringify(param),
                        contentType: "application/json; charset=utf-8",
                        success:function(){
                            layer.msg('添加成功', {icon: 1, time: 3000});
                            setTimeout(function () {window.location.href='<%=path%>/findPosition';},2000);
        ...
        function member_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("<%=path%>/deletePosition",{"id":id},function (data) {
                    if(data =true){
